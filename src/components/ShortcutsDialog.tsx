  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg z-50 rounded-xl border bg-card shadow-2xl overflow-hidden focus:outline-none max-h-[80vh] flex flex-col">
                ...
                <div className="space-y-0.5">
                  {group.shortcuts.map((item) => (
                    ...
                    >
                      ...
                      <kbd className="px-1.5 py-0.5 text-[11px] font-mono bg-secondary text-secondary-foreground rounded border border-border shrink-0 ml-4">
                        {item.keys}
                      </kbd>
                    </div>
                  ))}
          ...
          <div className="px-4 py-2 border-t text-[10px] text-muted-foreground shrink-0 flex items-center gap-1">
            ...
            <span>Press <kbd className="px-1 py-0.5 text-[10px] font-mono bg-secondary rounded border border-border">?</kbd> again to close</span>
          </div>
        </Dialog.Content>
      </Dialog.Portal>
    </Dialog.Root>
